...
# img = np.zeros((512,512,3), np.uint8)    ## img = np.zeros((600,600,3), np.uint8)
# cv2.imshow('image', img)
...
def click_event(event, x, y, flags, param ):
	...
	if event == cv2.EVENT_RBUTTONDOWN :
		...
		cv2.putText(img, strBGR, (x,y), font, 0.5, ( 0 , int(green) , int(red) ), 2)
		# cv2.imshow('image', img)
